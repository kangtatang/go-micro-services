...
// // Struct untuk menyimpan response dari employee service
...
// // Handler untuk menambahkan proyek baru
...
// 	resp, err := http.Get("http://localhost:3000/api/employees/" + string(employeeID))
// 	if err != nil {
// 		return nil, err
// 	}
...
// GetProjects untuk mendapatkan semua proyek
...
// GetProjects untuk mendapatkan semua proyek beserta detail karyawan
// func GetProjects(c *fiber.Ctx) error {
// 	rows, err := database.DB.Query("SELECT id, name, description, employee_id FROM projects")
// 	if err != nil {
// 		return c.Status(http.StatusInternalServerError).JSON(fiber.Map{"error": "Could not retrieve projects"})
...
// 	var projects []fiber.Map // Menggunakan fiber.Map untuk menyimpan data proyek beserta karyawan
// 	for rows.Next() {
// 		var project models.Project
// 		if err := rows.Scan(&project.ID, &project.Name, &project.Description, &project.EmployeeID); err != nil {
// 			return err
...
// GetProjectByID untuk mendapatkan proyek berdasarkan ID
...
// Fungsi untuk mengambil data karyawan dari employee service
// func fetchEmployee(employeeID int) (*Employee, error) {
// 	resp, err := http.Get("http://localhost:3000/api/employees/" + string(rune(employeeID)))
// 	if err != nil {
// 		return nil, err
// 	}
// 	defer resp.Body.Close()
